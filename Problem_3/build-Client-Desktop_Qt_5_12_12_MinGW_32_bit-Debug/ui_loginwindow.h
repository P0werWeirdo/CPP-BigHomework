...
public:
    ...
    void setupUi(QDialog *LoginWindow)
    {
        ...
        btn_Courier = new QRadioButton(widget_4);
        btn_Courier->setObjectName(QString::fromUtf8("btn_Courier"));

        horizontalLayout_7->addWidget(btn_Courier);
    ...
    void retranslateUi(QDialog *LoginWindow)
    {
        ...
        btn_Courier->setText(QApplication::translate("LoginWindow", "\345\277\253\351\200\222\345\221\230", nullptr));
