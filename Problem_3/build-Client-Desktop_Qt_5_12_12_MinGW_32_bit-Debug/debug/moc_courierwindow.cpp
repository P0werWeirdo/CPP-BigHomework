...
#include "../../Client/courierwindow.h"
...
QT_MOC_LITERAL(1, 14, 11), // "courierExit"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "CourierWindow\0courierExit\0"
};
...
void CourierWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->courierExit(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CourierWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CourierWindow::courierExit)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CourierWindow::courierExit()
{
