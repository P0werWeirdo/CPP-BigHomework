...
#include "../../Problem_1/registerwindow.h"
...
QT_MOC_LITERAL(1, 15, 9), // "hasFinish"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "RegisterWindow\0hasFinish\0"
};
...
void RegisterWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegisterWindow::hasFinish)) {
                *result = 0;
                return;
            }
        }
