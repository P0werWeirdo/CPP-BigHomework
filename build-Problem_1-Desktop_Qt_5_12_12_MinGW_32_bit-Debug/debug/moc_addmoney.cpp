/****************************************************************************
** Meta object code from reading C++ file 'addmoney.h'
**
...
#include "../../Problem_1/addmoney.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'addmoney.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 9, 9), // "addFinish"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "AddMoney\0addFinish\0"
};
...
void AddMoney::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (AddMoney::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddMoney::addFinish)) {
                *result = 0;
                return;
            }
        }
